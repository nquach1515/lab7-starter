...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let articlElRoot = document.createElement('article');
		// A3. TODO - Create a style element - This will hold all of the styles for the Web Component
		let styleElRoot = document.createElement('style');
		...
		shadowEl.append(articlElRoot);
		shadowEl.append(styleElRoot);
	}
